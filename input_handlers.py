...
from typing import Optional, Callable, Iterable, Tuple, Any, TYPE_CHECKING
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        Will move to a different position based on where the player is located, so the player can
...
class MainGameEventHandler(EventHandler):
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[Action]:
        ...
        # Switch to the appropriate event handler 
        # when player wants to use or drop an item
